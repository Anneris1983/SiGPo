...
- **Trabajo actual en la rama `desarrollo-38`** (copia de `desarrollo-37`, que a su vez salió de `desarrollo-36`). Acá se desarrolla y prueba sin afectar producción hasta que se decida mergear/publicar.
